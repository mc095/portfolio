    ...
    return (
      <main className="relative flex min-h-screen flex-col items-center justify-center p-4 sm:p-8 overflow-hidden">
        <div className="text-center max-w-4xl relative">
          ...
          <div className="relative p-8 rounded-3xl bg-zinc-900/50 backdrop-blur-sm border border-zinc-800/50 shadow-xl">
            <div className="text-left space-y-12">
              <div className="group relative p-6 rounded-2xl bg-accent/5 hover:bg-accent/10 transition-all duration-300">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 rounded-full bg-accent/10 text-accent/90 text-sm font-medium hover:bg-accent/20 transition-colors">
                    CSS
                  </span>
                  <span className="px-3 py-1 rounded-full bg-accent/10 text-accent/90 text-sm font-medium hover:bg-accent/20 transition-colors">
                    JavaScript
